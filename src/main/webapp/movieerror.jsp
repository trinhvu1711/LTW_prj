							...
							<c:forEach items="${requestScope.list}" var="c">
								<tr>
									...
									<td class="p-12">
										<div class="actions">
											<p class="lead">
												<a href="view?id=${c.id_movie}&tap=${c.tap}" class="btn btn-primary"><i
													class="las la-eye"></i> Open it</a>
											</p>
											<p class="lead">
												<a href="editmovieerror?id_episode=${c.id_episode}" class="btn btn-primary"><i
