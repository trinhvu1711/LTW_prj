            ...
            <body>
                                        ...
                                        <li class="dropdown mega-dropdown has-submenu">
                                            ...
                                            <ul class="dropdown-menu mega-dropdown-menu clearfix with-column-3-200"
                                                ...
                                                <c:forEach var="c" items="${c}">
                                                    <li> <a href="categoryfilter?id=${c.id}"
                                        ...
                                        <li class="dropdown mega-dropdown has-submenu">
                                            ...
                                            <ul class="dropdown-menu mega-dropdown-menu clearfix with-column-3-200"
                                                ...
                                                <c:forEach var="r" items="${r}">
                                                    <li> <a href="regionfilter?id=${r.id}"
                                ...
                                <div class="navbar-cell stretch">
                                    <form method="GET" class="form-search" action="searchfilm">
                                        <div class="input-group mb-sm">
                                            ...
                                            <span class="input-group-addon btn-search"> <i
                ...
                <div class="sb-slidebar sb-left">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown mega-dropdown has-submenu">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" title="Thể loại">Thể
                                loại
                        ...
                        <li class="dropdown mega-dropdown has-submenu">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" title="Quốc gia">Quốc
                                gia
                                <i class="sp-movie-icon-down"></i></a>
                            <ul class="dropdown-menu" role="menu">
                                <c:forEach var="r" items="${r}">
                        ...
                        <section id="content">
                            <div class="container-fluid clearfix">
                                <div class="container-wrapper">
                                    <ol class="breadcrumb clearfix" itemScope
                                        ...
                                        <li itemprop="itemListElement" itemscope=""
                                            ...
                                            <a class="" itemprop="item"
                                                href="https://default.ophimcms.com/quoc-gia/trung-quoc"
                                                title="Trung Quốc">
                                                <span itemprop="name">
                                                    Trung Quốc
                                                </span>
                                        ...
                                        <li itemprop="itemListElement" itemscope=""
                                            itemtype="http://schema.org/ListItem">
                                            <a class="" itemprop="item"
                                                href="https://default.ophimcms.com/the-loai/tam-ly" title="Tâm Lý">
                                                <span itemprop="name">
                                                    Tâm Lý
                                                </span>
                                            </a>
                                        ...
                                        <li itemprop="itemListElement" itemscope=""
                                            itemtype="http://schema.org/ListItem">
                                            <a class="" itemprop="item"
                                                href="https://default.ophimcms.com/the-loai/hoc-duong"
                                                title="Học Đường">
                                                <span itemprop="name">
                                                    Học Đường
                                                </span>
                                    ...
                                    <div class="movie-info clearfix">
                                        ...
                                        <div class="column-300 pull-left">
                                            <div class="thumbnail mb-none">
                                                <img class="info-poster-img" src="${movie.thumb_url}"
                                                    alt="${movie.name}" />
                                            </div>
                                            <div class="button-play">
                                                ...
                                                <a class="btn btn-red btn-rounded" title="${movie.name}"
                                                    href="${viewUrl}">
                                                                ...
                                                                <div class="trailer">
                                                                    <div class="trailer-image-wrap">
                                                                        <img class="lazyload lazy-loaded"
                                                                            ...
                                                                            alt="trailers" src="${movie.trailer_url}">
                                                                        <div class="icon-play"> <a
                                                                                href="javascript:void(0);"
                                                                                rel="nofollow" data-id="P2Dqud3ZZQU"> <i
                                                        ...
                                                        <div id="content-comment">
                                                            <div class="comment-input">
                                                                ...
                                                                <div class="ci-form">
                                                                    <div class="user-name">
                                                                        <span
                                                                            class="link-highlight">${account.name}</span>
                                                                    </div>
                                                            ...
                                                            <div class="cw_list">
                                                                <c:forEach items="${comments}" var="c">
                                                                    ...
                                                                    <div class="cw_l-line" id="cm-38">
                                                                        <div class="user-avatar">
                                                                            <img class="user-avatar-img" src="${link}"
                                                                                alt="${c.name}">
                                                                        </div>
                                                                        <div class="info">
                                                                            <div class="ihead">
                                                                                <c:if
                                                                                    test="${c.username == account.username}">
                                                                                    <span
                                                                                        class="link-highlight">${c.name}</span>
                                                                                </c:if>
                                                                                <c:if
                                                                                    test="${c.username != account.username}">
                                                                            ...
                                                                            <c:if
                                                                                ...
                                                                                <div class="ibottom">
                                                                                    <div class="ib-li ib-reply"
                                                                                        ...
                                                                                        <i class="mr-1"></i><a
                                                                                            class="btn"
                                                                                            href="deletecomment?id=${c.id}&movie_id=${movie.id}">Delete</a>
                                                                                    </div>
                                                    ...
                                                    <div class="block-content pt">
                                                        <div id="recoment-films" class="block-items row fix-row">
                                                            <c:forEach items="${recommend}" var="phim">
                                                                ...
                                                                <div
                                                                    class="col-xlg-2 col-lg-15 col-md-3 col-sm-4 col-xs-6">
                                                                    <div class="item">
                                                                        <a class="inner" href="${detailUrl}"
                                                                            ...
                                                                            <div class="description">
                                                                                <h3 class="text-nowrap">${phim.name}
                                                                                </h3>
                        ...
                        <div class="container-fluid clearfix">
                            <div class="row">
                                ...
                                <div class="contact_footer col-xs-12 col-sm-12 col-md-2">
                                    <p>Phim mới cập nhật liên tục, Xem phim online chất lượng cao, phim thuyết minh,
                                        phim
                                        Vietsub.
