	...
	<section id="content">
		...
		<main>
			...
			<ul class="breadcrumbs">
				<li><a href="#">Home</a></li>
				<li class="divider">/</li>
				<li><a href="#" class="active">Directors</a></li>
		...
		<div class="container-fluid">
			<div class="row function-bar">
				<p class="lead">
					<a href="addDirector.jsp" class="btn btn-primary"><i
						class="las la-plus"></i> Add director</a>
				</p>
					...
					<table class="crud-table">
						...
						<tbody>
							<c:forEach items="${requestScope.list}" var="c">
								<c:url var="deleteUrl" value="deleteDirector">
									<c:param name="id" value="${c.id}"></c:param>
								</c:url>
								<c:url var="editUrl" value="editDirector">
									<c:param name="id" value="${c.id}"></c:param>
								</c:url>
								<tr>
