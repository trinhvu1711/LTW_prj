                            ...
                            <div class="navbar-cell tight">
                                <div class="navbar-header">
                                    <a class="navbar-brand" href="home"
                                        title="Xem phim ${movie.name} ${movie.episode_current} Vietsub HD">
                                        VPhim
                                    </a>
                        ...
                        <div class="container-fluid clearfix">
                            <div class="container-wrapper">
                                <ol class="breadcrumb clearfix" itemScope itemType="https://schema.org/BreadcrumbList">
                                    ...
                                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                        <a class="" itemprop="item"
                                            href="https://default.ophimcms.com/the-loai/vo-thuat" title="Võ Thuật">
                                            <span itemprop="name">
                                                Võ Thuật
                                            </span>
                                        </a>
                                    ...
                                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                        <a class="" itemprop="item"
                                            href="https://default.ophimcms.com/the-loai/phieu-luu" title="Phiêu Lưu">
                                            <span itemprop="name">
                                                Phiêu Lưu
                                            </span>
                                        </a>
                                    ...
                                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                        <a class="" itemprop="item"
                                            href="https://default.ophimcms.com/the-loai/hoat-hinh" title="Hoạt Hình">
                                            <span itemprop="name">
                                                Hoạt Hình
                                            </span>
                                        </a>
                                    ...
                                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                        <a itemprop="item" href="${episode.link}" title="Tập 01">
                                    ...
                                    <div id="pl-content">
                                                        ...
                                                        <ul class="server-list">
                                                            <li class="backup-server"> <span class="server-title">Đổi
                                                                ...
                                                                <ul class="list-episode">
                                                                    <li class="episode">
                                                                        <a data-id="239471" data-link="${episode.link}"
                                                                            data-type="m3u8"
                                                ...
                                                <div class="mt clearfix">
                                                    <div class="pull-left">
                                                        <div id="lightOff" style="display: none;"></div> <a
                                                            ...
                                                            title="Tắt đèn" href="javascript:();" id="lightBtn"> <i
                                                        ...
                                                        <button style="margin-left: 5px;"
                                                            ...
                                                            id="btn-toggle-error" title="Báo lỗi phim ${movie.name}"> <i
                                                                class="fa fa-warning"></i><a
                                                                href="addmovieerror?id_movie=${movie.id}&tap=${tap}&id_episode=${episode.id}">
                                                                Báo lỗi</a> </button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="list-servers">
                                            <div class="block-heading">
                                                <h2 class="block-title weight-normal text-blue"> <i
                                                        class="fa fa-film"></i>
                                                    <a href="view?id=${movie.id}"> ${movie.name} </a>
                                                </h2>

                                            </div>
                                            <div class="server-name"><i class="sp-movie-icon-camera"></i> Vietsub
                                                #${tap+1}</div>
                                                        ...
                                                        <div id="mCSB_0_container"
                                                            ...
                                                            <c:forEach var="ep" items="${ep}" varStatus="loop">
                                                                <c:if test="${loop.index == tap}">
                                                                    <a class="btn btn-rounded btn-deep-orange active"
                                                                        title="${ep.name}"
                                                                        href="view?tap=${loop.index}&id=${movie.id}">${ep.name}</a>
                                                                </c:if>
                                                                <c:if test="${loop.index != tap}">
                                                                    <a class="btn btn-rounded btn-deep-orange"
                                                                        title="${ep.name}"
                                                                        href="view?tap=${loop.index}&id=${movie.id}">${ep.name}</a>
                                                                </c:if>
                                                            </c:forEach>
                                                            ...
                                                            <div id="content-comment">
                                                                <div class="comment-input">
                                                                    <div class="user-avatar">
                                                                        ...
                                                                        <c:if test="${(link == null) || (link == '')}">
                                                                            <c:set
                                                                                value="./assets/images/defaultavatar.jpg"
                                                                                var="link"></c:set>
                                                                        </c:if>
