...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li>
                <a href="#"><i class="las la-list icon"></i></i>Phân loại <i
                ...
                <ul class="side-dropdown">
                    ...
                    <li><a href="actor"><i class="lab la-gratipay icon"></i> Diễn viên</a></li>
                    <li><a href="director"><i class="lab la-odnoklassniki-square icon"></i> Đạo diễn</a></li>
                    <li><a href="studio"><i class="lab la-connectdevelop icon"></i> Studio</a></li>
                </ul>
            </li>
            <li><a href="#"><i class="las la-info-circle icon"></i></i>Phim lỗi</a></li>
            ...
            <li>
            <li>
                <a href="#"><i class="las la-paint-brush icon"></i>Giao diện <i
                        class="las la-angle-left icon-right icon"></i></a>
                <ul class="side-dropdown">
            ...
            <li>
                <a href="#"><i class="las la-cog icon"></i></i>Cài đặt <i
                        class="las la-angle-left icon-right icon"></i></a>
                <ul class="side-dropdown">
    ...
    <section id="content">
        <!-- NAVBAR -->
        <nav>
            <i class="las la-bars toggle-sidebar"></i>
            <span class="divider"></span>
            <div class="profile">
                <img src="./asserts/img/admin.png" alt="">
                <ul class="profile-link">
                    <li><a href="#"><i class="las la-user-circle icon"></i> Profile</a></li>
                    <li><a href="profile"><i class="las la-user-cog icon"></i> Settings</a></li>
                    <li><a href="logout"><i class="las la-sign-out-alt icon"></i> Logout</a></li>
                </ul>
            </div>
        </nav>
        <!-- NAVBAR -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-item">
                        ...
                        <input type="text" name="nname" value="${account.name}" class="mt-8">
                    </div>
                    <div class="card-item">
                        <label for="">Email</label>
                        <input type="text" name="nusername" value="${account.username}" class="mt-8">
                    </div>
                </div>
                ...
                <div class="card-body">
                   <input type="hidden" name="username" class="mt-8" value="${account.username}">
                    ...
                    <div class="card-item">
                        ...
                        <input type="text" name="opass" class="mt-8">
                    </div>
                    <div class="card-item">
                        <label for="">New password</label>
                        <input type="text" name="npass" class="mt-8">
                    </div>
                    <div class="card-item">
                        <label for="">Confirm password</label>
                        <input type="text" name="rpass" class="mt-8">
                    </div>
                </div>
                <div class="card-footer">
                    <button class="lead" type="submit">
