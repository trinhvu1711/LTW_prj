			...
			<section id="content">
				...
				<form action="updateProfile" method="post">
					<div class="card">
						...
						<div class="card-body">
							<input type="hidden" name="username" class="mt-8" value="${account.username}"> <input
								type="hidden" name="pass" class="mt-8" value="${account.password}"> <input type="hidden"
								name="pass" class="mt-8" value="${account.name}">
							<div class="card-item">
								<label for="">Name</label> <input type="text" name="nname" value="${account.name}"
									class="mt-8">
							</div>
							<div class="card-item">
				...
				<form action="changePasswordProfile" method="post">
					...
					<div class="card">
						...
						<div class="card-body">
							<input type="hidden" name="username" class="mt-8" value="${account.username}"> <input
								type="hidden" name="pass" class="mt-8" value="${account.password}">
							<div class="card-item">
								<label for="">Old password</label> <input type="text" name="opass" class="mt-8">
							</div>
							<div class="card-item">
								<label for="">New password</label> <input type="text" name="npass" class="mt-8">
							</div>
							<div class="card-item">
								<label for="">Confirm password</label> <input type="text" name="rpass" class="mt-8">
							</div>
						</div>
						<div class="card-footer">
							<button class="lead" type="submit">
