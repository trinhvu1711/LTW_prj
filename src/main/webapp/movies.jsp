						...
						<c:forEach items="${requestScope.list}" var="m">
							...
							<tbody>
								<tr>
									...
									<td class="p-12"><span>Hành Động, Hình Sự, Phiêu
											Lưu</span></td>
