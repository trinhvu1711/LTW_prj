			...
			<section id="content">
				...
				<div class="container-fluid">
					<div class="row function-bar">
						<p class="lead">
							<a href="addMovie" class="btn btn-primary"><i class="las la-plus"></i> Add movie</a>
						</p>
								...
								<tbody>
									<c:forEach items="${list}" var="m">
										...
										<tr>
											<td class="td-info">
												<div>
													...
													<div class="text-muted">
														<small>(${m.origin_name})<span
																class="text-danger">[${m.episode_current}]</span></small>
													</div>
											...
											<td class="p-12"><span> <a href="#"> <img src="${m.thumb_url}" alt="">
													</a>

												</span></td>
											<td class="p-12"><span>
													<c:forEach items="${m.getMovieCategories()}" var="c">
														${c.name}
													</c:forEach>
												</span></td>
											<td class="p-12">
												<c:forEach items="${m.getMovieRegions()}" var="c">
													${c.name}
												</c:forEach>
											</td>
											<td class="p-12">
