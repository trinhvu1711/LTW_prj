	...
	<section id="content">
		...
		<main>
			<div class="heading">
				...
				<h4>
					Edit director. <a href="">Back to all directors</a>
				</h4>
			</div>
		...
		<form action="editDirector" method="post">
			<div class="card">
				<div class="card-heading">
					<div>
						<input type="hidden" name="id" class="mt-8" value="${c.id}">
					</div>
					<div>
						<label for="">Tên</label> <input type="text" name="name"
							class="mt-8" value="${c.name}">
					</div>
					<div class="mt-15">
						<label for="">Đường dẫn tĩnh</label> <input type="text"
							name="slug" class="mt-8" value="${c.slug}">
					</div>
					<div class="mt-15">
