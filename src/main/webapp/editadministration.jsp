...
<body>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<form action="editadministration" method="post">
			<div class="card">
				<div class="card-heading">
					<div>
						<label for="">Tên</label> <input type="text" name="name"
							class="mt-8" value="${u.name}">
					</div>
					<div class="mt-15">
						 <input type="hidden"
							name="email" class="mt-8" value="${u.username}">
					</div>
					<div class="mt-15">
						<label for="">Mật khẩu</label> <input type="password"
							name="password" class="mt-8" value="${u.password}">
					</div>
					<div class="mt-15">
						<label for="">Xác nhận mật khẩu</label> <input type="password"
							name="repassword" class="mt-8" value="${u.password}">
					</div>
					<div class="mt-15">
						<input type="checkbox"
							name="role" class="mt-8"><label for=""> Admin</label> 
					</div>
				</div>
