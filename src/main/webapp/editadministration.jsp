			...
			<form action="editadministration" method="post">
				<div class="card">
					<div class="card-heading">
						<div>
							<label for="">Tên</label> <input type="text" name="name" class="mt-8" value="${u.name}">
						</div>
						<div class="mt-15">
							<input type="hidden" name="email" class="mt-8" value="${u.username}">
						</div>
						<div class="mt-15">
