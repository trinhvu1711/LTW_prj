			...
			<section id="content">
				...
				<div class="container-fluid">
					<div class="row function-bar">
						<p class="lead">
							<a href="addCategory" class="btn btn-primary"><i class="las la-plus"></i> Add category</a>
						</p>
							...
							<table class="crud-table">
								...
								<tbody>
									<c:forEach items="${requestScope.list}" var="c">
										<c:url var="deleteUrl" value="deleteCategory">
											<c:param name="id" value="${c.id}"></c:param>
										</c:url>
										<c:url var="editUrl" value="editCategory">
											<c:param name="id" value="${c.id}"></c:param>
										</c:url>
										<tr>
