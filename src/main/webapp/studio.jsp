			...
			<section id="content">
				...
				<main>
					...
					<ul class="breadcrumbs">
						<li><a href="#">Home</a></li>
						<li class="divider">/</li>
						<li><a href="#" class="active">Studios</a></li>
				...
				<div class="container-fluid">
					<div class="row function-bar">
						<p class="lead">
							<a href="addStudio.jsp" class="btn btn-primary"><i class="las la-plus"></i> Add Studio</a>
						</p>
							...
							<table class="crud-table">
								...
								<tbody>
									<c:forEach items="${requestScope.list}" var="c">
										<c:url var="deleteUrl" value="deleteStudio">
											<c:param name="id" value="${c.id}"></c:param>
										</c:url>
										<c:url var="editUrl" value="editStudio">
											<c:param name="id" value="${c.id}"></c:param>
										</c:url>
										<tr>
